...
<head>
    ...
    <link href="{{ asset('arkitektur-1.0.0/img/favicon.ico') }}" rel="icon">
    ...
    <link href="{{asset('arkitektur-1.0.0/lib/animate/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('arkitektur-1.0.0/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{asset('arkitektur-1.0.0/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css')}}" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('arkitektur-1.0.0/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('arkitektur-1.0.0/css/style.css ')}}"rel="stylesheet">
</head>
...
<body>
    ...
    <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <img class="position-absolute top-50 start-50 translate-middle" src="{{asset('arkitektur-1.0.0/img/icons/icon-1.png')}}" alt="Icon">
    </div>
    <!-- Spinner End -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="text-primary m-0"><img class="me-3" src="{{asset('arkitektur-1.0.0/img/icons/icon-1.png')}}" alt="Icon">Arkitektur</h1>
        </a>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative" data-dot="<img src='{{asset('arkitektur-1.0.0/img/carousel-1.jpg')}}'>">
                <img class="img-fluid" src="{{asset('arkitektur-1.0.0/img/carousel-1.jpg')}}" alt="">
     ...
     data-dot="<img src='{{ asset('arkitektur-1.0.0/img/carousel-2.jpg') }}' alt='carousel dot'>">
                <img class="img-fluid" src="{{asset('arkitektur-1.0.0/img/carousel-2.jpg')}}" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
...
<div class="container-xxl project py-5">
    <div class="container">
        ...
        <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="col-lg-4">
                <div class="nav nav-pills d-flex flex-column justify-content-start w-100 h-100 me-4">
                    @foreach ($projects as $project)
                        <button 
                            class="nav-link w-100 d-flex align-items-center text-start p-4 mb-2 {{ $loop->first ? 'active' : '' }}" 
                            data-bs-toggle="pill" 
                            data-bs-target="#tab-pane-{{ $project->id }}" 
                            type="button">
                            <h3 class="m-0">0{{ $loop->iteration }} {{ $project->title }}</h3>
                        </button>
                    @endforeach
                </div>
            </div>

            <!-- Right side: project images & details -->
            <div class="col-lg-8">
                <div class="tab-content w-100">
                    @foreach ($projects as $project)
                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-pane-{{ $project->id }}">
                            <div class="row g-4">
...
<div class="container-xxl py-5" id="project">
    ...
    <script src="{{asset('arkitektur-1.0.0/lib/wow/wow.min.js')}}"></script>
    <script src="{{asset('arkitektur-1.0.0/lib/easing/easing.min.js')}}"></script>
    <script src="{{asset('arkitektur-1.0.0/lib/waypoints/waypoints.min.js')}}"></script>
    <script src="{{asset('arkitektur-1.0.0/lib/counterup/counterup.min.js')}}"></script>
    <script src="{{asset('arkitektur-1.0.0/lib/owlcarousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('arkitektur-1.0.0/lib/tempusdominus/js/moment.min.js')}}"></script>
    <script src="{{asset('arkitektur-1.0.0/lib/tempusdominus/js/moment-timezone.min.js')}}"></script>
    <script src="{{asset('arkitektur-1.0.0/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js')}}"></script>

    <!-- Template Javascript -->
    <script src="{{asset('arkitektur-1.0.0/js/main.js')}}"></script>
</body>
